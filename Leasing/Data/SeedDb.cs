...
namespace Leasing.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("0801-1987-13256", "Gerardo", "Lanza", "glanza007@gmail.com", "3307-7964", "Calle El Paraiso", "Manager");
            var owner = await CheckUserAsync("0801-1998-92027", "Antonio", "Pavón", "antonio@yopmail.com", "350 634 2747", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("0801-1998-22020", "Andrea", "Matamoros", "andrea@yopmail.com", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
        ...
        private async Task CheckPropertiesAsync()
        {
            ...
            {
                AddProperty("Calle 43 #23 32", "Tatumbla", owner, propertyType, 800000M, 2, 72, 4);
